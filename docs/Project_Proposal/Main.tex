...
\usepackage{float} % Allows putting an [H] in \begin{figure} to specify the exact location of the figure
	...
	\begin{document}
		...
		\begin{titlepage}
			...
			\HRule \\[0.4cm]
			{ \huge \color{PSUgreen}\bfseries Project Proposal for \texorpdfstring{\gls{bms}}{Battery Management System (BMS)} \\[0.4cm] \Large \emph{Sponsored by \texorpdfstring{\gls{vms}}{Viking Motorsports (VMS)}}}\\[0.4cm] % Title of your document
			\HRule \\[1.5cm]
		...
		\newpage
		\section{Product Design Specification}
		\label{Product_Design_Specification}
		\input{Section_3}
		\pagebreak
